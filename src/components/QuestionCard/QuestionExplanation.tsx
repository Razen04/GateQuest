...
const QuestionExplanation: React.FC<QuestionExplanationProps> = ({ question }) => {
    ...
    return (
        <div className="my-4 question-explanation border-l-4 border-blue-500 pl-4 overflow-x-auto bg-blue-50/50 dark:bg-blue-900/10 p-2 rounded-r">
            <h4 className="text-xl font-semibold text-blue-500 dark:text-blue-400 mb-1">Explanation</h4>
            <p className="text-xs text-blue-400 dark:text-blue-300 mb-4 italic">
                This is the official explanation. If it seems incorrect or unclear,
                please report it.
            </p>
