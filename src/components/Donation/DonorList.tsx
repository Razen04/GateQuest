                ...
                <ul className="space-y-4">
                    {donations.map((donation) => (
                        <li
                            ...
                            className="flex items-start gap-4 p-4 rounded-2xl bg-gradient-to-tr from-blue-50 to-white dark:from-zinc-700/70 dark:to-zinc-800 border border-blue-100 dark:border-zinc-700 hover:scale-[1.02] hover:shadow-lg transition-transform duration-200"
                        >
                            <div className="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-md">
                                {donation.anonymous || !donation.user_avatar ? (
                                    ...
                                    <img src={donation.user_avatar} className="rounded-full" />
                                )}
                            </div>
                            <div className="flex-1">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="bg-green-100 dark:bg-green-900/40 text-green-600 dark:text-green-300 font-semibold text-sm px-2 py-1 rounded-full">
