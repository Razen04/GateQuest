...
const Login = () => {
    ...
    return (
        <div className="relative flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-100 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900">
            <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl border border-border-primary dark:border-border-primary-dark p-8 flex flex-col items-center animate-fade-in">
                <button onClick={toggleLogin} className='p-2 rounded-full hover:bg-red-400 absolute right-3 top-3 cursor-pointer font-bold text-lg'><FaXmark /></button>
                <div className="mb-8 w-full text-center">
                    <h1 className="text-3xl font-extrabold text-blue-700 dark:text-blue-300 mb-2 tracking-tight">Welcome to GateQuest</h1>
