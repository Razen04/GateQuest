...
import { containerVariants, itemVariants, navItemVariants, stagger } from '../../utils/motionVariants'
            ...
            <div className={`p-6 min-h-[100dvh] transition-colors duration-500 bg-primary dark:bg-primary-dark text-text-primary dark:text-text-primary-dark ${showLogin ? 'blur-2xl' : null}`}>
                ...
                >
                    <h1 className="text-3xl font-bold">
                        <span className="bg-gradient-to-br from-blue-400 to-blue-600 bg-clip-text text-transparent">Settings</span> & Preferences
                    </h1>
                        ...
                        {tabs.map((tab) => {
                            ...
                            return (
                                <motion.button
                                    ...
                                    className={`relative flex cursor-pointer items-center px-4 py-2 sm:py-3 rounded-lg transition-colors duration-300 whitespace-nowrap text-sm sm:text-base z-10 ${isActive
                                        ? 'text-white'
                                        : 'hover:bg-gray-100/50 dark:hover:bg-gray-700/50 text-text-primary dark:text-text-primary-dark'
                                        }`}
                                >
                                    <span className="mr-2">{isActive ? tab.activeIcon : tab.icon}</span>
