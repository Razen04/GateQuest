...
const SmartRevision = () => {
    ...
    // helper function to check if the set is finished or not
    const isSetFinished = () => {
        if (!currentSet) return false;

        return currentSet && currentSet.questions.every((q) => q.is_correct !== null);
    };
            ...
            >
                <div className="bg-white dark:bg-zinc-600/5 p-8 shadow-sm border border-gray-100 dark:border-zinc-900 relative overflow-hidden">
                    <div className="relative z-10 flex flex-col items-center justify-center min-h-[140px] text-center">
                        {currentSet && !isSetFinished() ? (
                        ...
                        ) : criticalQuestionsCount > 0 && !isSetFinished() ? (
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-gray-500 dark:text-gray-400 mt-2 max-w-sm">
                                    Your revision queue is empty. Great job! Go and practice some
                                    more questions for the next week.
                                </p>
                            </div>
                        )}
                    </div>
