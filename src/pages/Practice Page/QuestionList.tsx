...
import useFilters from '../../hooks/useFilters.ts'; // Applies all the search/filter logic.
import useUrlFilters from '../../hooks/useUrlFilters.ts'; // Syncs filter state with the URL. Super important for shareable links.
...
const QuestionsList = () => {
    ...
    const years = useMemo(() => {
        ...
        const allYears = filteredQuestions.map((q: Question) => q.year).filter((y) => !isNaN(y));
