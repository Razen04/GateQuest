...
INSERT INTO public.user_incorrect_queue (
    user_id, question_id, box, added_at, next_review_at
)
VALUES
-- === 6 due for review (next_review_at <= NOW()) ===
('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 1,
 NOW() - INTERVAL '10 days', NOW() - INTERVAL '1 day'),

('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002', 1,
 NOW() - INTERVAL '8 days', NOW() - INTERVAL '2 days'),

('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000003', 2,
 NOW() - INTERVAL '7 days', NOW() - INTERVAL '3 hours'),

('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000004', 2,
 NOW() - INTERVAL '5 days', NOW() - INTERVAL '30 minutes'),

('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000005', 1,
 NOW() - INTERVAL '3 days', NOW() - INTERVAL '10 minutes'),

('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000006', 3,
 NOW() - INTERVAL '2 days', NOW() - INTERVAL '1 minute'),

-- === 4 NOT due yet (next_review_at > NOW()) ===
('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000007', 1,
 NOW() - INTERVAL '1 day', NOW() + INTERVAL '1 day'),

('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000008', 2,
 NOW() - INTERVAL '12 hours', NOW() + INTERVAL '2 days'),

('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000009', 3,
 NOW() - INTERVAL '6 hours', NOW() + INTERVAL '3 hours'),

('00000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000010', 1,
